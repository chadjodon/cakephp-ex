...
class JSFXMLWriter {
   ...
   function startElement($el){
      if ($this->openElement==true) {
         $this->xml.=">\n";
         $this->openElement = false;
      }
      for ($i=0; $i<($this->indent*$this->level); $i++) $this->xml.=" ";
      $this->xml.="<".$el;
      $this->openElement =true;
      $this->currentElement[$this->level] = $el;
      $this->level++;
   }
   ...
   function  writeElement($el,$value){
      ...
      for ($i=0; $i<($this->indent*$this->level); $i++) $this->xml.=" ";
      $this->xml.="<".$el."><![CDATA[".$value."]]></".$el.">\n";
      //$this->xml.="<".$el.">".$value."</".$el.">\n";
   }
   ...
   function endElement(){
      ...
      $this->level--;
      for ($i=0; $i<($this->indent*$this->level); $i++) $this->xml.=" ";
      $this->xml .= "</".$this->currentElement[$this->level].">\n";
   }
