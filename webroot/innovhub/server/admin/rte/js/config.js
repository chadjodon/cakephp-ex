...
rteFormName = "contents";
// Height of the rich text editor.
rteHeight = "400px";
// Path to the images folder.
rteImagePath = "/jsfadmin/rte/images/";
// Path to insert form popup.
rteHTMLPathInsertForm = "/jsfadmin/rte/html/insert_form.html";
// Path to insert checkbox popup.
rteHTMLPathInsertCheckbox = "/jsfadmin/rte/html/insert_checkbox.html";
// Path to insert radio button popup.
rteHTMLPathInsertRadiobutton = "/jsfadmin/rte/html/insert_radiobutton.html";
// Path to insert text area popup.
rteHTMLPathInsertTextArea = "/jsfadmin/rte/html/insert_textarea.html";
// Path to insert submit button popup.
rteHTMLPathInsertSubmit = "/jsfadmin/rte/html/insert_submit.html";
// Path to insert image submit button popup.
rteHTMLPathInsertImageSubmit = "/jsfadmin/rte/html/insert_image_submit.html";
// Path to reset form button popup.
rteHTMLPathInsertReset = "/jsfadmin/rte/html/insert_reset.html";
// Path to insert hidden form field popup.
rteHTMLPathInsertHidden = "/jsfadmin/rte/html/insert_hidden.html";
// Path to insert password field popup.
rteHTMLPathInsertPassword = "/jsfadmin/rte/html/insert_password.html";
// Path to insert text field popup.
rteHTMLPathInsertText = "/jsfadmin/rte/html/insert_text.html";
// Path to insert table popup.
rteHTMLPathInsertTable = "/jsfadmin/rte/html/insert_table.html";
// Path to edit table properties popup.
rteHTMLPathEditTable = "/jsfadmin/rte/html/edit_table.html";
// Path to insert link popup.
rteHTMLPathInsertLink = "/jsfadmin/rte/html/insert_link.html";
// Path to edit link popup.
rteHTMLPathEditLink = "/jsfadmin/rte/html/edit_link.html";
// Path to insert image popup.
rteHTMLPathInsertImage = "/jsfadmin/rte/html/insert_image.html";
rteHTMLPathUploadImage = "/jsfadmin/rte/html/upload_image.php";
rteHTMLPathChoseImage = "/jsfadmin/rte/html/chose_image.php";
