...
Html2Xhtml.prototype.parse=function(){
   ...
   while(1){
      ...
      case 12:
         if(c==quot){
            state=11;
            xhtml+=quot+Html2Xhtml.escapeQuot(phpval,quot)+quot;phpval=quot='';
            break;
         }
         phpval+=c;
         break;
...
function rteGetOffsetLeft(elm) { var mOffsetLeft = elm.offsetLeft; var mOffsetParent = elm.offsetParent; while(mOffsetParent) { mOffsetLeft += mOffsetParent.offsetLeft; mOffsetParent = mOffsetParent.offsetParent;}
return mOffsetLeft;};
...
function rteMouseOverMenuFontColorContents() { this.className = "rtedropdown14";}; 

function rteMouseOutMenuFontColorContents() { this.className = "rtedropdown13";}; 
...
function rteMouseDownMenuContents() { 
   if (this.innerHTML == "Header 1") { 
      ...
      document.getElementById("format1").innerHTML = "Header 1";
       ...
       document.getElementById(rteName).contentWindow.document.execCommand("formatblock", false, "<div>"); 
...
function rteMouseOutFormatMenu() { document.getElementById("format1").className = "rtedropdown1"; document.getElementById("format2").className = "rtedropdown2";}; 

function rteMouseOverFontFaceMenu() { document.getElementById("fontface1").className = "rtedropdown4"; document.getElementById("fontface2").className = "rtedropdown5";}; 

function rteMouseDownFontFaceMenu() { rteHideMenus(); document.getElementById("fontface1").className = "rtedropdown4"; document.getElementById("fontface2").className = "rtedropdown6"; document.getElementById("fontface1").style.left = rteGetOffsetLeft(document.getElementById("fontface1")); document.getElementById("fontface1").style.top = rteGetOffsetTop(document.getElementById("fontface1")) + document.getElementById("fontface1").offsetHeight; document.getElementById("fontface3").style.display = (document.getElementById("fontface3").style.display == "none" ) ? "" : "none"; var kids = document.getElementsByTagName('DIV'); for (var i=0; i < kids.length; i++) { if (kids[i].id == "format1" || kids[i].id == "format2") { kids[i].onmouseout = rteMouseOutFormatMenu;} else if (kids[i].id == "fontface1" || kids[i].id == "fontface2") { kids[i].onmouseout = rteMouseDownFontFaceMenu;} else if (kids[i].id == "fontsize1" || kids[i].id == "fontsize2") { kids[i].onmouseout = rteMouseOutFontSizeMenu;} else if (kids[i].id == "fontcolor1" || kids[i].id == "fontcolor2") { kids[i].onmouseout = rteMouseOutFontColorMenu;}
}
}; 

function rteMouseOutFontFaceMenu() { document.getElementById("fontface1").className = "rtedropdown1"; document.getElementById("fontface2").className = "rtedropdown2";}; 

function rteMouseOverFontSizeMenu() { document.getElementById("fontsize1").className = "rtedropdown4"; document.getElementById("fontsize2").className = "rtedropdown5";}; 
...
function rteMouseOutFontSizeMenu() { document.getElementById("fontsize1").className = "rtedropdown1"; document.getElementById("fontsize2").className = "rtedropdown2";}; 

function rteMouseOverFontColorMenu() { document.getElementById("fontcolor1").className = "rtedropdown8"; document.getElementById("fontcolor2").className = "rtedropdown5b";}; 
...
function rteBtnMouseUpBottom() { this.className = "rtebtn9";}

function rteBtnMouseOutBottom() { this.className = "rtebtn6";};

function rteBtnMouseOutDownBottom() { this.className = "rtebtn9";};

function rteBtnMouseOverBottom() { this.className = "rtebtn7";};
...
rteSelection(); this.className = "rtebtn4";}; function rteBtnMouseUp() { this.className = "rtebtn4";}; function rteBtnMouseOut() { this.className = "rtebtn1";}; function rteBtnMouseOver() { this.className = "rtebtn2";}; 

function rteBtnInsertImage() { 
   window.open(rteHTMLPathInsertImage , "blank","toolbar=no,width=300,height=220");
}; 

function rteBtnUploadImage() { 
   window.open(rteHTMLPathUploadImage , "blank","toolbar=no,scrollbars=yes,width=300,height=350");
};

function rteBtnChoseImage() { 
   window.open(rteHTMLPathChoseImage , "blank","toolbar=no,scrollbars=yes,width=500,height=400");
}; 

function rteBtnEditLink() { window.open(rteHTMLPathEditLink , "blank","toolbar=no,width=250,height=300");}; 

function rteBtnEditTable() { window.open(rteHTMLPathEditTable , "blank","toolbar=no,width=320,height=210");}; 

function rteBtnCreateLink() { window.open(rteHTMLPathInsertLink , "blank","toolbar=no,width=250,height=300");}; 

function rteBtnPrint() { 
   if (document.all){ var oFrame = window.frames[rteName]; oFrame.focus(); oFrame.print();
   } else { 
...
function rteInsertHTML(html) {
   ...
   insertAtCursor(document.getElementById(rteName).contentWindow,html);
};
...
function insertAtCursor(myField, myValue) {
  ...
  //MOZILLA/NETSCAPE support
       ...
       var userSelection = myField.getSelection(); 
       myField.document.execCommand('insertHTML',false,myValue); 
...
{ document.getElementById("tb1").style.display = "none"; document.getElementById("tb2").style.display = "none";} else { document.getElementById("format1").innerHTML = "Paragraph"; document.getElementById("fontface1").innerHTML = "Verdana"; document.getElementById("fontsize1").innerHTML = "2"; var kids = document.getElementsByTagName('DIV'); for (var i=0; i < kids.length; i++) { switch(kids[i].className)
{ case "rtebtn1":
...
if (!rteInsertForm && !rteInsertCheckbox && !rteInsertRadio && !rteInsertSelect && !rteInsertTextArea && !rteInsertSubmit && !rteInsertImageSubmit && !rteInsertReset && !rteInsertHidden && !rteInsertPassword && !rteInsertTextField) { document.getElementById("rtesep10").style.display = "none";}
if (!rtePrint && !rteSelectAll && !rteSpellCheck) { document.getElementById("rtesep11").style.display = "none";}
}; 

function initRTE(rtePreloadContent, rteCSS, inputName, totalHeight) {
   if (inputName !== undefined) rteFormName=inputName;
   if (totalHeight !== undefined) rteHeight=totalHeight;
   if (!document.designMode) { 
      document.write('<textarea id="' + rteFormName + '" name="' + rteFormName + '" style="width:' + rteWidth + ';height:' + rteHeight + ';"></textarea>');
   } else { 
      document.write('<style>'); document.write('.rtebg {'); document.write('	background-image:url(' + rteImagePath + 'bg.gif);'); 
      document.write('	font-family:Arial, Helvetica, sans-serif;'); document.write('	font-size:10px;'); document.write('}'); 
      ...
      document.write('				</tr>'); 
      document.write('				<tr>'); 
      document.write('					<td><div id="fontcolor" class="rtedropdown13"><img src="' + rteImagePath + 'fontcolor3.gif" style="background-color:#579fb3;" onClick="rteColorClick(\'#579fb3\');"></div></td>'); 
      document.write('					<td><div id="fontcolor" class="rtedropdown13"><img src="' + rteImagePath + 'fontcolor3.gif" style="background-color:#115e74;" onClick="rteColorClick(\'#115e74\');"></div></td>'); 
      document.write('					<td><div id="fontcolor" class="rtedropdown13"><img src="' + rteImagePath + 'fontcolor3.gif" style="background-color:#FFFF99;" onClick="rteColorClick(\'#FFFF99\');"></div></td>'); 
      document.write('					<td><div id="fontcolor" class="rtedropdown13"><img src="' + rteImagePath + 'fontcolor3.gif" style="background-color:#CCFFCC;" onClick="rteColorClick(\'#CCFFCC\');"></div></td>'); 
      document.write('					<td><div id="fontcolor" class="rtedropdown13"><img src="' + rteImagePath + 'fontcolor3.gif" style="background-color:#CCFFFF;" onClick="rteColorClick(\'#CCFFFF\');"></div></td>'); 
      document.write('					<td><div id="fontcolor" class="rtedropdown13"><img src="' + rteImagePath + 'fontcolor3.gif" style="background-color:#99CCFF;" onClick="rteColorClick(\'#99CCFF\');"></div></td>'); 
      ...
      document.write('  <tr>'); 
      document.write('    <td bgcolor="#C3DAF9">'); 
      document.write('	<table cellpadding="0" cellspacing="0" id="tb2" onmousedown="return false;">'); 
      document.write('      <tr>'); 
      document.write('        <td width="7"><img src="' + rteImagePath + 'start.gif" width="7" height="25" /></td>'); 
      document.write('        <td class="rtebg"><img src="' + rteImagePath + 'blank.gif"></td>'); 
      ...
      //document.write('        <td class="rtebg" title="Upload Image"><div id="uploadimage" class="rtebtn1"><a href="javascript:rteBtnUploadImage();" style="cursor:default;"><img src="' + rteImagePath + 'uploadimage.gif" border="0"></a></div></td>');
      document.write('        <td class="rtebg" title="Choose Image"><div id="choseimage" class="rtebtn1"><a href="javascript:rteBtnChoseImage();" style="cursor:default;"><img src="' + rteImagePath + 'choseimage.gif" border="0"></a></div></td>');
